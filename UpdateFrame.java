...
JTextField txtname,txtrno,txtmarks,txtgrade,txtpercentage;
JLabel lbname,lbmarks,lbrno,lbgrade,lbpercentage;
UpdateFrame()
{
c=getContentPane();
...
String grade="";
int marks=0,rno=0;
int output=JOptionPane.showConfirmDialog(new JDialog(),"ARE YOU REALLY WANT TO UPDATE.");
...
{
new DbHandler().updateStudent(rno,name,marks,percentage,grade);
}
else
{
if(rno < 0)
